...
class AddMoneyManualFieldWidget extends StatelessWidget {
  AddMoneyManualFieldWidget({super.key});
  ...
  _content(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          TextWidget(
            controller.manualInputModel.data.gateway.desc,
  ...
  _buttonWidget(BuildContext context) {
    return Obx(
      () => PrimaryButton(
        ...
        onPressed: () {
          controller.addMoneyManualConfirm();
        },
      ),
    );
  }
